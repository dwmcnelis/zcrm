<?php
namespace CustomerApiTest\Controller;

use CustomerApiTest\Bootstrap;
use CustomerApi\Controller\CustomerApiController;
...
class CustomerApiControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CustomerApiController();
